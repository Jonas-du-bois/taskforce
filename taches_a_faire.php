...
<body>
    <div class="d-flex">
        ...
        <div class="main-content ms-auto col-md-9 col-lg-10 p-5">
            <h2 class="text-center mb-4 text-danger"><? echo t('tasks_to_do')?></h2>
                            ...
                            <?php foreach ($tachesAFaire as $task): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge <?php echo getStatusBadgeClass(statut: $task->getFormattedStatut()); ?> me-1">
                                            <i class="bi bi-hourglass-split"><? echo t('todo') ?></i> <?php htmlspecialchars($task->getFormattedStatut()); ?>
                                        </span>
                                    </td>
                                    <td>
